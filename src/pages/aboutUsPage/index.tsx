...
export const AboutUsPage = () => {
  ...
  const scrollPrev = () => {
    ...
    return (
        <>
            {/* Landing Section */}
            <div className='grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 p-5 gap-8 lg:gap-12'>
                <div className='flex flex-col justify-center'>
                    <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-center lg:text-left'>
                        Building the Future, One Project at a Time.
                    </h1>
                    <h4 className='text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 text-center lg:text-left'>
                ...
                <div className='flex justify-center'>
                    <img src={testImg} className='rounded-2xl w-full h-auto object-cover' />
                </div>
            </div>

            {/* Our Story section */}
            <div className='mt-10 px-5 sm:px-10 md:px-20 lg:px-40'>
                <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-5xl text-center font-bold mb-3'>Our Story</h1>
                <h3 className='text-base sm:text-lg md:text-xl text-gray-500 text-center mb-10'>A legacy of building and innovation.</h3>
            ...
            {/* Our Core Values */}
            {/* Desktop view */}
            <div className="hidden sm:inline-block mt-10 px-5 sm:px-10 md:px-20 lg:px-40 mb-10">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl text-center font-bold mb-3">Our Core Values</h1>
                <h3 className="text-base sm:text-lg md:text-xl text-gray-500 text-center mb-10">
            ...
            {/* mobile view */}
            <div className="relative mt-10 px-5 sm:px-10 md:hidden">
                <h1 className="text-3xl text-center font-bold mb-3">Our Core Values</h1>
                <h3 className="text-base text-gray-500 text-center mb-6">
                    Guiding principles that define our commitment.
                </h3>
                ...
                <div className="relative">
                    ...
                    <button
                        onClick={scrollPrev}
                        className="absolute left-0 top-1/2 transform -translate-y-1/2 z-20 bg-white text-gray-700 rounded-full p-2 shadow hover:bg-gray-100"
                    >
                        &#8592;
                    </button>
                    ...
                    >
                    {coreValues.map((value, index) => (
                        <div className="flex-shrink-0 w-72 scroll-snap-item" key={index}>
                        <CoreValueCard
                            key={index}
                            title={value.valueTitle}
                            description={value.valueDesc}
                    ...
                    <button
                        onClick={scrollNext}
                        className="absolute right-0 top-1/2 transform -translate-y-1/2 z-20 bg-white text-gray-700 rounded-full p-2 shadow hover:bg-gray-100"
                    >
                        &#8594;
                    </button>
                </div>
